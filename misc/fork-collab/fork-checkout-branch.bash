...
# This script is only meant for checkout of branches on the Eclipse Foundation
# GitLab server (gitlab.eclipse.org) that are forks of the official Eclipse
# ESCET Git repository.

# Usage: misc/fork-collab/fork-checkout-branch.bash <username> <branch_name>
...
git fetch "$GITLAB_URL" "$GITLAB_BRANCH_NAME"
