...
set +e
cat DEPENDENCIES.generated.txt | grep -v -e "^maven/mavencentral/org.eclipse.escet/" -e "^p2/orbit/p2.eclipse.plugin/org.eclipse.escet" > DEPENDENCIES.generated.processed.txt
