...
EXCLUDE_ARGS="$EXCLUDE_ARGS --exclude=*.icns"
...
EXCLUDE_ARGS="$EXCLUDE_ARGS --exclude=*.xpm"
...
EXCLUDE_ARGS="$EXCLUDE_ARGS --exclude=*.out.cifx"
...
POST_EXCLUDE_PATTERN="$POST_EXCLUDE_PATTERN|^./.mvn/maven.config:0$"
...
POST_EXCLUDE_PATTERN="$POST_EXCLUDE_PATTERN|^./cif/org.eclipse.escet.cif.tests/tests/plcgen/.*_s7-.*/CONSTANTS.xml:0$"
...
POST_EXCLUDE_PATTERN="$POST_EXCLUDE_PATTERN|^./cif/org.eclipse.escet.cif.tests/tests/plcgen/.*_s7-.*/OUTPUTS.xml:0$"
