...
/** Command handler for supervisor synthesis. */
public class SupervisorSynthesisCommandHandler extends SingleFileCommandHandler {
    @Override
    ...
    protected Class<? extends Application<?>> getApplicationClass() {
        return SupervisorSynthesisApplication.class;
    }
}
