...
/** Command handler for synchronous product. */
public class SynchronousProductCommandHandler extends SingleFileCommandHandler {
    @Override
    ...
    protected Class<? extends Application<?>> getApplicationClass() {
        return SynchronousProductApplication.class;
    }
}
