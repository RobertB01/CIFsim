...
/** Command handler for automaton abstraction. */
public class AutomatonAbstractionCommandHandler extends SingleFileCommandHandler {
    @Override
    ...
    protected Class<? extends Application<?>> getApplicationClass() {
        return AutomatonAbstractionApplication.class;
    }
}
