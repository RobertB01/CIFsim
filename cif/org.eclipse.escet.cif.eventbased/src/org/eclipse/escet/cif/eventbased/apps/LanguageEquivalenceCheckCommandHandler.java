...
/** Language equivalence check command handler. */
public class LanguageEquivalenceCheckCommandHandler extends SingleFileCommandHandler {
    @Override
    ...
    protected Class<? extends Application<?>> getApplicationClass() {
        return LanguageEquivalenceCheckApplication.class;
    }
}
