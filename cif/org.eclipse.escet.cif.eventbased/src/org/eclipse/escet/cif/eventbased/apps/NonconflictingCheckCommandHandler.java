...
/** Nonconflicting check command handler. */
public class NonconflictingCheckCommandHandler extends SingleFileCommandHandler {
    @Override
    ...
    protected Class<? extends Application<?>> getApplicationClass() {
        return NonconflictingCheckApplication.class;
    }
}
