...
public class PlcIntTypeSizeOption extends EnumOption<PlcNumberBits> {
    ...
    public PlcIntTypeSizeOption() {
        super("PLC integer type size",
                ...
                null, "int-size", "BITS", PlcNumberBits.AUTO, true, "The number of bits for an integer value in PLC.");
    }
    ...
    /**
     * Returns the number of bits for an integer value in the PLC.
     *
     * @return The number of bits for an integer value in the PLC.
     */
