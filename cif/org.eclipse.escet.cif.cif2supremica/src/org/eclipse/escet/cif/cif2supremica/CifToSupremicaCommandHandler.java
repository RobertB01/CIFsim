...
/** Handler for Eclipse UI command for CIF to Supremica transformation. */
public class CifToSupremicaCommandHandler extends SingleFileCommandHandler {
    @Override
    protected Class<? extends Application<?>> getApplicationClass() {
        return CifToSupremicaApp.class;
    }
