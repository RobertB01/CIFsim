...
/** Real stochastic distribution. */
public abstract class RealDistribution implements RuntimeToStringable {
    /**
     ...
     */
    public abstract RealDistribution copy();

    /**
     * Take a sample from the real distribution.
     *
