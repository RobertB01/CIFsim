    ...
    public InputModeOption() {
        super("Input mode",
                "The input mode that determines the method by which the simulator can request input, such as which "
                        + "transition to choose. Specify \"interactive\" (deprecated) for interactive console input "
                        + "mode, \"console\" for interactive console input mode, \"gui\" (default) for interactive GUI "
                        + "input mode, \"auto\" for automatic input mode, \"trace\" for trace input mode, or \"svg\" "
                        + "for SVG input mode (requires the use of SVG visualization).",
