...
/**
 * Runtime edge representation, for synchronization event use and for event 'tau'.
 *
 * @param <S> The type of state objects to use.
 */
public abstract class RuntimeSyncEdge<S extends RuntimeState> extends RuntimeEdge<S> {
    /**
