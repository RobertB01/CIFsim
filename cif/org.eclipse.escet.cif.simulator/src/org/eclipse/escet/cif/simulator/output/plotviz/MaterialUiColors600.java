...
/** Material UI colors (level 600). */
@SuppressWarnings("javadoc")
public class MaterialUiColors600 {
    // See https://materialuicolors.co/
    ...
    /** Material UI colors (level 600). */
    public static final Color[] COLORS = {RED, LIGHT_GREEN, BLUE, YELLOW, ORANGE, PURPLE, TEAL, CYAN, BROWN, INDIGO,
            GREEN, GREY};

    /** Constructor for the {@link MaterialUiColors600} class. */
