...
This can be achieved with <<tut-time-chapter-continuous-variables,continuous variables>>, discussed in the next lesson.
...
For further details on urgency, see the future <<tut-time-chapter-urgency,urgency>> lesson.
