...
For an example of how these concepts can be used for modeling of a concrete example, see the section on <<sbe-with-cif,synthesis-based engineering with CIF>>.
