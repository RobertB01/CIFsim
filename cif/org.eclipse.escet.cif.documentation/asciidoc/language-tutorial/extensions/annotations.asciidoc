...
Currently, annotations are only supported for algebraic variables, continuous variables, discrete variables, input variables, and locations of automata, but this will be extended to other elements of specifications in the future.
