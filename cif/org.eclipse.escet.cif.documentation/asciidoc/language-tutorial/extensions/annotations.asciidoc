...
Currently, annotations are only supported for algebraic variables, constants, continuous variables, discrete variables, events, input variables, locations of automata, and specifications, but this will be extended to other elements of specifications in the future.
