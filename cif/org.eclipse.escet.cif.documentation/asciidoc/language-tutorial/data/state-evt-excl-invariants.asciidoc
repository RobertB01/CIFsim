...
In some cases, it might be useful to given invariants names.
It may improve the readability of the model and it makes it easier to refer to them in text.
...
As a result, it it not possible to give a name to a combined invariant for multiple events.
