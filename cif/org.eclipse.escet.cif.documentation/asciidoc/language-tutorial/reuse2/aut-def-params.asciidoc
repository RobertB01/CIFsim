...
In the <<tut-reuse2-chapter-aut-def-inst,previous lesson>>, automaton definition/instantiation was used to obtain two identical automata, while only having to specify their behavior once.
...
The details of the different kind of parameters of automaton definitions are explained in the <<tut-reuse2-chapter-aut-def-param-kinds,next lesson>>.
