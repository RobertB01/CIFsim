...
Finally, consider the following CIF specification, based on the link:http://en.wikipedia.org/wiki/Nonlinear_system[non-linear system] from the lesson on <<lang-tut-time-chapter-equations,equations>>.
