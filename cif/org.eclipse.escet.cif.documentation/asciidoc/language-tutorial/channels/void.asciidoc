...
Consider again the producer/consumer example from the <<tut-channels-chapter-intro,previous lesson>>, with one producer and two consumers, but without identification numbers for the products:
