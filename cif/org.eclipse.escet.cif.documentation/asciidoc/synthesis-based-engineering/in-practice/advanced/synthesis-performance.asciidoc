...
* See the page of the Eclipse ESCET general toolkit documentation on link:https://www.eclipse.dev/escet/{escet-website-version}/performance/index.html[resolving performance and memory problems].
