...
Show the use of equations for both continuous and algebraic variables, by means of an example of a link:http://en.wikipedia.org/wiki/Nonlinear_system>[non-linear system].
