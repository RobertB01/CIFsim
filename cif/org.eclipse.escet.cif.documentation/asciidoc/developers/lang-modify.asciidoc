...
* Update Ecore metamodel.
Update Ecore diagram images.
* Update Ecore genmodel.
Remove and re-generate model code.
* Update generated Java constructors and walker code.
* Update LaTeX documentation skeleton files.
* Update LaTeX documentation, including constraints.
Generate new PDF.
