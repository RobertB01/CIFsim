...
* The CIF to Supremica transformation does now correctly transform multiple guards on an edge. Multiple guards are now combined into a single conjunction (issue {escet-issue}620[#620]).
