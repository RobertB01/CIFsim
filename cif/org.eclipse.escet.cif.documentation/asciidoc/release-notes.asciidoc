...
The preconditions themselves have not changed (issue {escet-issue}368[#368]).
* Some very small documentation improvements (issues {escet-issue}199[#199] and {escet-issue}438[#438]).
