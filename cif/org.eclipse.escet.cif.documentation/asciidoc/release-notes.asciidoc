...
The default configuration for variable ordering has not been changed.
...
* The CIF data-based synthesis tool DCSH variable ordering algorithm is no longer considered experimental.
It is still disabled by default (issue {escet-issue}378[#378]).
* The CIF data-based synthesis tool documentation has been split up into multiple pages, and has various small improvements (issues {escet-issue}426[#426] and {escet-issue}492[#492]).
* The CIF data-based synthesis tool documentation related to variable ordering has been extended and improved (issues {escet-issue}378[#378] and {escet-issue}530[#530]).
...
* The CIF data-based synthesis tool _BDD variable order_ option has been renamed to _BDD initial variable ordering_ (issue {escet-issue}530[#530]).
* The CIF data-based synthesis tool _BDD initial variable ordering_ option now supports leading and trailing whitespace (issue {escet-issue}378[#378]).
* The CIF data-based synthesis tool termination request detection has been improved, reducing the number of times it is unnecessarily checked (issue {escet-issue}198[#198]).
