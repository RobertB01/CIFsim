...
Documentation about this feature is mostly absent.
Annotations should be considered an experimental language feature for now (issue {escet-issue}593[#593]).
...
* The CIF data-based synthesis tool now has improved edge selection heuristics for the workset algorithm, improving the performance of the workset algorithm.
The workset algorithm is still be considered experimental (issues {escet-issue}520[#520] and {escet-issue}605[#605]).
