...
* The CIF code generator now generates JavaScript and HTML code that logs the initial state and states reached after event transitions (issue {escet-issue}715[#715]).
...
* The CIF website and documentation have various small improvements and extensions (issues {escet-issue}38[#38], {escet-issue}727[#727], {escet-issue}752[#752], {escet-issue}756[#756], {escet-issue}764[#764] and {escet-issue}766[#766]).
