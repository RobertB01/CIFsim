...
* Variables being assigned on edges can now be referred to by any reference expression rather than only be identifiers (issue #227).
...
In the Eclipse ESCET IDE it can now be found in the _CIF miscellaneous tools_ sub-menu (issue #188).
