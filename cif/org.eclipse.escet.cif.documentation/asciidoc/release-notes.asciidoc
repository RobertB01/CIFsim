...
* Annotations may now be added to automata, enumerations, enumeration literals, events, functions, function parameters, function variables, groups, invariants, specifications and type declarations.
