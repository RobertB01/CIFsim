...
The new PLC code generator is currently being developed, and is not yet functional.
In due time, it will replace the current CIF PLC code generator (issues {escet-issue}397[#397], {escet-issue}676[#676] and {escet-issue}679[#679]).
...
The JavaScript code generation is currently being developed, and is not yet functional (issue {escet-issue}272[#272]).
...
* The CIF documentation has various small improvements and fixes (issues {escet-issue}593[#593], {escet-issue}648[#648] and {escet-issue}682[#682]).
