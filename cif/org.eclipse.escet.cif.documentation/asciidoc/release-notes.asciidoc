...
All CIF tools that may report on invariants give improved file position information, such as for type checker errors and precondition violation reports (issue {escet-issue}591[#591]).
