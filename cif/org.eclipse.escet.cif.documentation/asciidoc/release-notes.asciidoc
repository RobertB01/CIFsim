...
* Annotations may now be added to discrete variables.
...
* The (still experimental) new CIF PLC code generator has various improvements and fixes related to names in the generated code, including among others better handling of keywords, and not generating names with multiple consecutive underscores (issue {escet-issue}679[#679]).
