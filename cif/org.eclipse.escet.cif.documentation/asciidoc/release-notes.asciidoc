...
The text editor theming behavior can be configured via the Eclipse Preferences dialog (issue {escet-issue}386[#386]).
...
The preconditions themselves have not changed (issue {escet-issue}398[#398]).
* The CIF text editor light theme's default color has changed from a near-black slightly-brown color to pure black (issue {escet-issue}386[#386]).
* The CIF to yEd transformer syntax highligher's default color has changed from a near-black slightly-brown color to pure black (issue {escet-issue}386[#386]).
