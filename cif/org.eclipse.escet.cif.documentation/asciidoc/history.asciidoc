...
Like in a dictionary that explains an unknown word in terms of many known words, transformations used elaborate combinations of CIF concepts to express the foreign concept in CIF.
...
Therefore, rather than having two subtle different languages, the goals of CIF 3 were extended to also cover the goals of SEAL.
