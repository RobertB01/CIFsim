...
Languages and tools considered to be in scope at the time were those from computer science and from dynamics and control, and focussing on modeling, simulation, analysis, controller synthesis, and verification in the area of discrete event, timed, and hybrid systems.
