...
The synthesis algorithm ensures that in the controlled system, the requirement
...
The synthesis algorithm checks the uncontrolled system for common issues, for
