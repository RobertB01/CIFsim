...
Different algorithms may use different representations of the variable relations, which currently include _hyper-edges_ and _graph edges_.
The graph edges are derived from the hyper-edges.
...
More information about the various representations of variable relations may be obtained during synthesis by enabling <<tools-datasynth-dbg-output,debug output>>.
