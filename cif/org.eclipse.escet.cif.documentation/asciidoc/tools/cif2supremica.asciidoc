...
link:http://supremica.org/[Supremica] is a tool for synthesis of discrete event supervisors.
...
* In Eclipse, right click a `.cif` file in the 'Project Explorer' tab or 'Package Explorer' tab and choose menu:CIF synthesis tools[Convert CIF to Supremica...].
