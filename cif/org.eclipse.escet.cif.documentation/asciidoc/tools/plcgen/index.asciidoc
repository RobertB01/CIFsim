...
** Use _Automatically decide how to handle enumerations_ (`==convert-enums=auto`) if the target type should decide.
This is the default value of the option.
It will pick one of the other other values to convert enumerations.
