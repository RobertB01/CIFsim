...
** The word `resp`, which means that the PLC code generator takes the loop bound limit from the controller properties annotation in the specification as the limit value.
