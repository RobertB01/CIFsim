...
The CIF PLC code generator only contains a crude check.
A more sophisticated check can be done by checking the finite response property of the input specification with the <<tools-chapter-controller-checker,controller checker>> tool.
