...
This option sets or disables the upper limits on the number of attempts to perform transitions for the uncontrollable and/or controllable events in a single PLC cycle.
+
