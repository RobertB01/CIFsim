...
When performing operations on CIF specifications, the specification is first
...
specification the error is found.
...
may increase the performance of subsequent transformations.

Applying this transformation has no effect on the actual contents of the
...
Since position information is removed from the specification, this
