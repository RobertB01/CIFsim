...
Invariants (with the same supervisory kind) of the original automata (including ones from locations) are merged together in a similar way as the initialization and marker predicates.
