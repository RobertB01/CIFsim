...
This transformation does not process or add or any specific annotations.
The annotations of the original locations are moved to the enumeration literals of the newly created location pointer enumerations, but only for automata with at least two locations.
For automata with a single location, the annotations of the locations are removed.
The single new location does not have any annotations.
