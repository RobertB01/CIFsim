...
features of the CIF language that certain tools don't support.
...
All I/O declarations are removed from the specification. I/O declarations
include:
...
This transformation removes all I/O declarations. To only remove certain kinds
of I/O declarations, see the following CIF to CIF transformations:
