...
* <<tools-cif2cif-chapter-convert-uncontrollable-events-to-controllable>> (`convert-uncontrollable-events`)
* <<tools-cif2cif-chapter-convert-controllable-events-to-uncontrollable>> (`convert-controllable-events`)
