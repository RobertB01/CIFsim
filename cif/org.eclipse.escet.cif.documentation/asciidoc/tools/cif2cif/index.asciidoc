...
* Right click a `.cif` file in the 'Project Explorer' tab or 'Package Explorer' tab and choose menu:CIF miscellaneous tools[Apply CIF to CIF transformations...].
...
To add a transformation, double click it, or select it and click the _Add_ button below the list of available transformations.
To remove a transformation, double click on it in the list of chosen transformations, or select it in that list and click the _Remove_ button.
+
