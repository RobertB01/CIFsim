...
* <<tools-cif2cif-chapter-convert-uncontrollable-events-to-controllable>> (`convert-uncntrl-events-to-cntrl`)
* <<tools-cif2cif-chapter-convert-controllable-events-to-uncontrollable>> (`convert-cntrl-events-to-uncntrl`)
