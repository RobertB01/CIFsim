...
When two automata are not language equivalent, a counter example is produced that show the problem including the sequence of events to reach the equivalent locations.
