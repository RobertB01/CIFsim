...
By default all `.cif` files are opened with the CIF text editor.
However, large files are opened by the default non-CIF text editor, to prevent performance issues.
