...
When an input variable is merged with anything but a discrete variable, location, or another input variable, the annotations of the input variable are discarded.
