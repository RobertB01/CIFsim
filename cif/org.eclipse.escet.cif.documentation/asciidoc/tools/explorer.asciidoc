...
The resulting CIF specification is itself not annotated with any annotations.
The events in the resulting CIF specification do not have any annotations either.
