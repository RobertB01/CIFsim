...
* The documentation of algebraic variables, constants, discrete variables, enumeration literals, events, input variables, locations of automata with at least two locations, and specifications is included in the generated code.
