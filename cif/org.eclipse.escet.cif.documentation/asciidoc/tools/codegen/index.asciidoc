...
The generated C89, C99, Java and JavaScript code maintains the running time in seconds.
...
The documentation of input variables is included in the generated code.
The documentation of the locations of automata is ignored.
