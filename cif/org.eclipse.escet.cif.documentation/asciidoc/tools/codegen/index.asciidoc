...
* CIF/SVG declarations are supported only or HTML code generation.
...
* The documentation of algebraic variables, constants, discrete variables and input variables is included in the generated code.
