...
* The documentation of algebraic variables, constants, discrete variables, events, input variables and specifications is included in the generated code.
* The documentation of continuous variables is also included in the generated code, except when generating Simulink code.
* The documentation of the locations of automata, and of type declarations is ignored.
