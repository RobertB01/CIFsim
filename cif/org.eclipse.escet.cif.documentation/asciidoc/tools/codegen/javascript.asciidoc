...
JavaScript is a weakly typed language, so CIF data types are not directly applicable. This part of the documentation is under construction and will be added to during development.
