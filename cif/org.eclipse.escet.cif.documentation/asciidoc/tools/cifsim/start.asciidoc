...
* In Eclipse, right click a `.cif` file in the 'Project Explorer' tab or 'Package Explorer' tab and choose menu:Simulate CIF specification...[].

* In Eclipse, right click an open text editor for a `.cif` file and choose menu:Simulate CIF specification...[].
