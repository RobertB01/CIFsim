...
The menu:ODE solver integrator algorithm[] option (menu:ODE solver: ODE integrator[] category) can be used to configure the integrator algorithm to use.
...
* link:http://en.wikipedia.org/wiki/Dormand-Prince[Dormand-Prince 8(5,3)] (default)

* link:http://en.wikipedia.org/wiki/Bulirsch-Stoer_algorithm[Gragg-Bulirsch-Stoer]

* link:http://en.wikipedia.org/wiki/Adams_method[Adams-Bashforth] (experimental)

* link:http://en.wikipedia.org/wiki/Adams_method[Adams-Moulton] (experimental)
...
All these algorithms use an link:http://en.wikipedia.org/wiki/Adaptive_stepsize[adaptive step size].
...
The menu:ODE solver integrator absolute tolerance[] option (menu:ODE solver: ODE integrator[] category) and the menu:ODE solver integrator relative tolerance[] option (menu:ODE solver: ODE integrator[] category), can be used to configure how precise the results of the integrator should be.
...
The interval between two consecutive time points calculated by the integrator can be configured using the menu:ODE solver integrator minimum step size[] option (menu:ODE solver: ODE integrator[] category) and the menu:ODE solver integrator maximum step size[] option (menu:ODE solver: ODE integrator[] category).
...
The menu:ODE solver integrator number of steps[] option (menu:ODE solver: ODE integrator[] category) can be used to configure the number of steps to use for the experimental link:http://en.wikipedia.org/wiki/Adams_method[Adams-Bashforth] and link:http://en.wikipedia.org/wiki/Adams_method[Adams-Moulton] integrators.
