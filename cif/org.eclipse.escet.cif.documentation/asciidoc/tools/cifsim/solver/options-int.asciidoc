...
The _ODE solver integrator number of steps_ option (_ODE solver: ODE integrator_ category) can be used to configure the number of steps to use for the experimental link:http://en.wikipedia.org/wiki/Adams_method[Adams-Bashforth] and link:http://en.wikipedia.org/wiki/Adams_method[Adams-Moulton] integrators.
