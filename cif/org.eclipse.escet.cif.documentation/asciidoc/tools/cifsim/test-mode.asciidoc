...
* The user is no longer asked to <<tools-cifsim-termination-confirm,confirm termination>> of the simulator, if the the _Ask to confirm simulator termination_ option (_Simulator_ category) is configured to let the simulator decide whether to ask the user for confirmation or terminate automatically.
