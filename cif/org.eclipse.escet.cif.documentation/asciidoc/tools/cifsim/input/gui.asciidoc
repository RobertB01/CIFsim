...
If choices are available, the box is green for <<lang-tut-extensions-synthesis-evtctrl,controllable>> events, red for <<lang-tut-extensions-synthesis-evtctrl,uncontrollable>> events, blue for other events, and black for everything else (_time delay_, _reset_, and _undo_).
