...
It can be enabled using the menu:Plot visualization[] option (menu:Output: Plot visualization[] category).
...
Using the menu:Plot visualization filters[] option (menu:Output: Plot visualization[] category), the state objects can be filtered.
The menu:Plot visualization filters[] option only has effect if plot visualization is enabled, using the menu:Plot visualization[] option.
...
However, using the menu:Plot visualization filters[] option (menu:Output: Plot visualization[] category), it is possible to specify that multiple visualizers should be used.
...
Which plot visualization mode to use, can be configured using the menu:Plot visualization mode[] option (menu:Output: Plot visualization[] category).
...
To keep the plot useful, the range of time values to display on the x-axis can be configured using the menu:Plot visualization range[] option (menu:Output: Plot visualization[] category).
...
Then select menu:File[Save As...] to open the menu:Save plot as[] dialog.
Alternatively, right click the plot itself, and choose menu:Save As...[] from the popup menu, to open the menu:Save plot as[] dialog.
