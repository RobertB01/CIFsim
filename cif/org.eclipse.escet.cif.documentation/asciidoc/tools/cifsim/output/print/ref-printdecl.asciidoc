...
Print declarations are link:http://en.wikipedia.org/wiki/Declarative_programming[declarative], rather than link:http://en.wikipedia.org/wiki/Imperative_programming[imperative].
...
By default text is printed to the console, to the link:http://en.wikipedia.org/wiki/Standard_streams[standard output stream], usually called 'stdout'.
...
* `":stdout"`: prints to the link:http://en.wikipedia.org/wiki/Standard_streams[standard output stream].
In Eclipse, the text ends up on the console, as black text.

* `":stderr"`: prints to the link:http://en.wikipedia.org/wiki/Standard_streams[standard error stream].
