...
If they don't specify anything, the default is to print to the link:http://en.wikipedia.org/wiki/Standard_streams[standard output stream], usually called 'stdout'.
