...
Enable the menu:Trajectory data[] option (menu:Output: Trajectory data[] category) to enable writing the trajectory data to a file.
...
Using the menu:Trajectory data file[] option (menu:Output: Trajectory data[] category), a different file can be specified.
...
Using the menu:Trajectory data filters[] option (menu:Output: Trajectory data[] category), the state objects can be filtered.
The menu:Trajectory data filters[] option only has effect if trajectory data output is enabled, using the menu:Trajectory data[] option.
...
This can be changed using the menu:Trajectory data separation amount[] option (menu:Output: Trajectory data[] category).
