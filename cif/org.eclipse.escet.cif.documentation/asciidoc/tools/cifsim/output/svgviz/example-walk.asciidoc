...
This is reflected in the XML as a `transform` attribute, with the `translate(-78,15)` value.
This indicates that the person was moved 78 pixels to the left, and 15 pixels to the bottom (as SVG has its origin in the upper left corner of the canvas).
