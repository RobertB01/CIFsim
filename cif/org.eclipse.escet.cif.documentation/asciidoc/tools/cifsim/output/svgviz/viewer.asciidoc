...
Then select menu:File[Save As...] to open the menu:Save SVG as[] dialog.
Alternatively, right click the SVG image itself, and choose menu:Save As...[] from the popup menu, to open the menu:Save SVG as[] dialog.
