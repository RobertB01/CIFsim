...
The menu:SVG visualization[] option (menu:Output: SVG visualization[] category) can be used to disable SVG visualization.
...
* link:http://camstudio.org/[CamStudio] for Microsoft Windows.
