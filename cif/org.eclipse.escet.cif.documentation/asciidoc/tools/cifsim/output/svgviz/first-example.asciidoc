...
Start link:http://inkscape.org/[Inkscape], Select menu:File[Document Properties...], to open the _Document Properties_ window.
On the _Page_ tab, set the _Units_ to _px_, the _Width_ to `75.00`, and the _Height_ to `100.00`.
