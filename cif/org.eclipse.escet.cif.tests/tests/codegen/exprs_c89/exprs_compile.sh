...
# PRINT_OUTPUT
# If set, 'print' statements are forwarded to exprs_PrintOutput.

# EVENT_OUTPUT
# If set, performed events are reported to exprs_EventOutput
...
gcc $CFLAGS -c -o exprs_library.o exprs_library.c
gcc $CFLAGS -c -o exprs_engine.o exprs_engine.c
gcc $CFLAGS -c -o exprs_test_code.o exprs_test_code.c
gcc $CFLAGS -o exprs_engine_test exprs_test_code.o exprs_engine.o exprs_library.o $LFLAGS
