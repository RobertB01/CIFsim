The 'fmt_*' files here are generated using the CIF to C99 code generator.
Below is a description of what it contains, and how to use and/or tailor them
towards your wishes.

Generated files
===============
* fmt_library.c and fmt_library.h
...
* fmt_InfoEvent(fmt_Event_ event, BoolType pre)
  Announcement or report of an event taking place. Can be disabled with a
  compile-time flag.

* fmt_PrintOutput(const char *line, const char *fname)
...
* EVENT_OUTPUT
  ...
  external "fmt_InfoEvent" function. There is no CIF equivalent of this
  function.

* PRINT_OUTPUT
  If true (-DPRINT_OUTPUT=1), print statements are performed as specified in
  CIF. The results are routed to the external "fmt_PrintOutput" function.
