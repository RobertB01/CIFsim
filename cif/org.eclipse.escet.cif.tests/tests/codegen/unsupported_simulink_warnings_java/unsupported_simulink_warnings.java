...
/** unsupported_simulink_warnings code generated from a CIF specification. */
@SuppressWarnings("unused")
public abstract class unsupported_simulink_warnings {
    ...
    /** Discrete variable "a.d1". */
    public CifTuple_T2II a_d1_;

    /** Discrete variable "a.d2". */
    public String a_d2_;

    /** Discrete variable "a.d3". */
    public List<CifTuple_T2II> a_d3_;

    /** Discrete variable "a.d4". */
    public List<String> a_d4_;

    /** Discrete variable "a.d5". */
    public List<List<CifTuple_T2II>> a_d5_;

    /** Discrete variable "a.d6". */
    public List<List<String>> a_d6_;

    /** Discrete variable "a.d7". */
    public List<List<List<Boolean>>> a_d7_;


    /** Constructor for the {@link unsupported_simulink_warnings} class. */
    public unsupported_simulink_warnings() {
        firstExec = true;
        this.time = 0.0;
    }
     ...
     *      execution.
     * @throws unsupported_simulink_warningsException In case of a runtime error caused by code
    ...
    private void initState() {
        a_d1_ = new CifTuple_T2II(0, 0);
        a_d2_ = "";
        a_d3_ = makelist(new ArrayList<CifTuple_T2II>(1), new CifTuple_T2II(0, 0));
        a_d4_ = makelist(new ArrayList<String>(1), "");
        a_d5_ = makelist(new ArrayList<List<CifTuple_T2II>>(1), makelist(new ArrayList<CifTuple_T2II>(1), new CifTuple_T2II(0, 0)));
        a_d6_ = makelist(new ArrayList<List<String>>(1), makelist(new ArrayList<String>(1), ""));
        a_d7_ = makelist(new ArrayList<List<List<Boolean>>>(1), makelist(new ArrayList<List<Boolean>>(1), makelist(new ArrayList<Boolean>(1), false)));
    }
     ...
     */
    public CifTuple_T2II a1_() {
        return new CifTuple_T2II(1, 2);
    }
     ...
     * @return The evaluation result.
     */
    public List<CifTuple_T2II> a3_() {
        return makelist(new ArrayList<CifTuple_T2II>(1), new CifTuple_T2II(1, 2));
    }
     ...
     * @return The evaluation result.
     */
    public List<String> a4_() {
        return makelist(new ArrayList<String>(1), "a");
    }

    /**
     * Evaluates algebraic variable "a5".
     *
     * @return The evaluation result.
     */
    public List<List<CifTuple_T2II>> a5_() {
        return makelist(new ArrayList<List<CifTuple_T2II>>(1), makelist(new ArrayList<CifTuple_T2II>(1), new CifTuple_T2II(1, 2)));
    }

    /**
     * Evaluates algebraic variable "a6".
     *
     * @return The evaluation result.
     */
    public List<List<String>> a6_() {
        return makelist(new ArrayList<List<String>>(1), makelist(new ArrayList<String>(1), "a"));
    }

    /**
     * Evaluates algebraic variable "a7".
     *
     * @return The evaluation result.
     */
    public List<List<List<Boolean>>> a7_() {
        return makelist(new ArrayList<List<List<Boolean>>>(1), makelist(new ArrayList<List<Boolean>>(1), makelist(new ArrayList<Boolean>(1), true)));
    }
    ...
    /** Tuple class for CIF tuple type representative "tuple(int x; int y)". */
     ...
     *      as file separators. Use {@link unsupported_simulink_warningsUtils#normalizePrintTarget}
    ...
    /**
     * unsupported_simulink_warnings exception.
     *
     * <p>Indices a runtime error while executing the generated code.</p>
     */
    public static class unsupported_simulink_warningsException extends RuntimeException {
        /**
         * Constructor for the {@link unsupported_simulink_warningsException} class.
         *
         * @param message The message describing the exception.
         */
        public unsupported_simulink_warningsException(String message) {
            super(message);
        }
         ...
         */
        public unsupported_simulink_warningsException(String message, Throwable cause) {
            super(message, cause);
        }
    ...
    /** {@link unsupported_simulink_warnings} utility code. */
    public static class unsupported_simulink_warningsUtils {
        /** The file separator for the current platform. */
        private static final String FILE_SEPARATOR = System.getProperty("file.separator");

        /** Constructor for the {@link unsupported_simulink_warningsUtils} class. */
        private unsupported_simulink_warningsUtils() {
            // Static class.
        }
         ...
         * @return {@code abs(x)}.
         * @throws unsupported_simulink_warningsException If the operation results in integer
         *      overflow.
         */
        public static int abs(int x) {
            if (x == Integer.MIN_VALUE) {
                String msg = fmt("Integer overflow: abs(%d).", x);
                throw new unsupported_simulink_warningsException(msg);
            }
            return Math.abs(x);
        }
         ...
         * @param x The real number.
         * @return {@code acos(x)}.
         * @throws unsupported_simulink_warningsException If the operation results in real overflow,
         *      or {@code NaN}.
         */
        ...
        */
         ...
         * @param x The real number.
         * @return {@code ln(x)}.
         * @throws unsupported_simulink_warningsException If the real number is non-positive.
         */
         ...
         * @param y The divisor.
         * @return {@code x mod y}.
         * @throws unsupported_simulink_warningsException If the operation results in division by
         *      zero.
         */
         ...
         * @throws unsupported_simulink_warningsException If the index is out of range for the list.
         */
         ...
         * @throws unsupported_simulink_warningsException If the index is out of range for the
         *      string.
         */
         ...
         *      as end-user readable text.
         * @throws unsupported_simulink_warningsException Always thrown.
         */
         ...
         * @throws unsupported_simulink_warningsException If the input interval is empty, or the
         ...
         * @param x The real number.
         * @return {@code sqrt(x)}.
         * @throws unsupported_simulink_warningsException If the real number is negative.
         */
         ...
         * @throws unsupported_simulink_warningsException If the string value does not represent a
         *      boolean value.
         */
         ...
         * @throws unsupported_simulink_warningsException If the string value does not represent an
         *      integer value.
         */
        ...
        public static String valueToStr(Object value) {
            ...
            } else if (value instanceof unsupported_simulink_warnings.CifTupleBase) {
                return value.toString();
