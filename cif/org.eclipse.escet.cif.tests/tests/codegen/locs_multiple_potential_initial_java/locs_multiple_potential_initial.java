...
/** locs_multiple_potential_initial code generated from a CIF specification. */
@SuppressWarnings("unused")
public abstract class locs_multiple_potential_initial {
    ...
    /** Discrete variable "a". */
    public locs_multiple_potential_initialEnum a_;


    /** Constructor for the {@link locs_multiple_potential_initial} class. */
    public locs_multiple_potential_initial() {
        firstExec = true;
        this.time = 0.0;
    }
     ...
     *      execution.
     * @throws locs_multiple_potential_initialException In case of a runtime error caused by code
    ...
    private void initState() {
        a_ = locs_multiple_potential_initialEnum._loc1;
    }
    ...
    /**
     * Evaluates algebraic variable "a.x".
     *
     ...
     *      as file separators. Use {@link locs_multiple_potential_initialUtils#normalizePrintTarget}
    ...
    /**
     * locs_multiple_potential_initial exception.
     *
     * <p>Indices a runtime error while executing the generated code.</p>
     */
    public static class locs_multiple_potential_initialException extends RuntimeException {
        /**
         * Constructor for the {@link locs_multiple_potential_initialException} class.
         *
         * @param message The message describing the exception.
         */
        public locs_multiple_potential_initialException(String message) {
            super(message);
        }
         ...
         */
        public locs_multiple_potential_initialException(String message, Throwable cause) {
            super(message, cause);
        }
    ...
    /** {@link locs_multiple_potential_initial} utility code. */
    public static class locs_multiple_potential_initialUtils {
        /** The file separator for the current platform. */
        private static final String FILE_SEPARATOR = System.getProperty("file.separator");

        /** Constructor for the {@link locs_multiple_potential_initialUtils} class. */
        private locs_multiple_potential_initialUtils() {
            // Static class.
        }
         ...
         * @return {@code abs(x)}.
         * @throws locs_multiple_potential_initialException If the operation results in integer
         *      overflow.
         */
        public static int abs(int x) {
            if (x == Integer.MIN_VALUE) {
                String msg = fmt("Integer overflow: abs(%d).", x);
                throw new locs_multiple_potential_initialException(msg);
            }
            return Math.abs(x);
        }
         ...
         * @param x The real number.
         * @return {@code acos(x)}.
         * @throws locs_multiple_potential_initialException If the operation results in real overflow,
         *      or {@code NaN}.
         */
        ...
        */
         ...
         * @param x The real number.
         * @return {@code ln(x)}.
         * @throws locs_multiple_potential_initialException If the real number is non-positive.
         */
         ...
         * @param y The divisor.
         * @return {@code x mod y}.
         * @throws locs_multiple_potential_initialException If the operation results in division by
         *      zero.
         */
         ...
         * @throws locs_multiple_potential_initialException If the index is out of range for the list.
         */
         ...
         * @throws locs_multiple_potential_initialException If the index is out of range for the
         *      string.
         */
         ...
         *      as end-user readable text.
         * @throws locs_multiple_potential_initialException Always thrown.
         */
         ...
         * @throws locs_multiple_potential_initialException If the input interval is empty, or the
         ...
         * @param x The real number.
         * @return {@code sqrt(x)}.
         * @throws locs_multiple_potential_initialException If the real number is negative.
         */
         ...
         * @throws locs_multiple_potential_initialException If the string value does not represent a
         *      boolean value.
         */
         ...
         * @throws locs_multiple_potential_initialException If the string value does not represent an
         *      integer value.
         */
        ...
        public static String valueToStr(Object value) {
            ...
            } else if (value instanceof locs_multiple_potential_initial.CifTupleBase) {
                return value.toString();
