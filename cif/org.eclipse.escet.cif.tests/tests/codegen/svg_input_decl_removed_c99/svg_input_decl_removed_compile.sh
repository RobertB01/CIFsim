...
# PRINT_OUTPUT
# If set, 'print' statements are forwarded to svg_input_decl_removed_PrintOutput.

# EVENT_OUTPUT
# If set, performed events are reported to svg_input_decl_removed_EventOutput
...
gcc $CFLAGS -c -o svg_input_decl_removed_library.o svg_input_decl_removed_library.c
gcc $CFLAGS -c -o svg_input_decl_removed_engine.o svg_input_decl_removed_engine.c
gcc $CFLAGS -c -o svg_input_decl_removed_test_code.o svg_input_decl_removed_test_code.c
gcc $CFLAGS -o svg_input_decl_removed_engine_test svg_input_decl_removed_test_code.o svg_input_decl_removed_engine.o svg_input_decl_removed_library.o $LFLAGS
