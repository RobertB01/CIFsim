The 'annos_doc_*' files here are generated using the CIF to C99 code generator.
Below is a description of what it contains, and how to use and/or tailor them
towards your wishes.

Generated files
===============
* annos_doc_library.c and annos_doc_library.h
...
* annos_doc_engine.c and annos_doc_engine.h
...
* annos_doc_AssignInputVariables(void)
...
* annos_doc_InfoEvent(annos_doc_Event_ event, BoolType pre)
  Announcement or report of an event taking place. Can be disabled with a
  compile-time flag.

* annos_doc_PrintOutput(const char *line, const char *fname)
...
* EVENT_OUTPUT
  ...
  external "annos_doc_InfoEvent" function. There is no CIF equivalent of this
  function.

* PRINT_OUTPUT
  If true (-DPRINT_OUTPUT=1), print statements are performed as specified in
  CIF. The results are routed to the external "annos_doc_PrintOutput" function.
