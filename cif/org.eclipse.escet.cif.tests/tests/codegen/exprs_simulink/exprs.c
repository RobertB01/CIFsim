...
struct WorkStruct {
    ...
    int_T a1_x_;            /**< Discrete variable "int a1.x". */
    BoolType AA_vb_;        /**< Discrete variable "bool AA.vb". */
    int_T AA_vi_;           /**< Discrete variable "int AA.vi". */
    int_T AA_vp_;           /**< Discrete variable "int[1..3] AA.vp". */
    int_T AA_vn_;           /**< Discrete variable "int[-5..-1] AA.vn". */
    int_T AA_vz_;           /**< Discrete variable "int[0..5] AA.vz". */
    real_T AA_vr_;          /**< Discrete variable "real AA.vr". */
    ...
    real_T AA_v2_;          /**< Discrete variable "real AA.v2". */
    real_T AA_i2r_;         /**< Discrete variable "real AA.i2r". */
    ...
    int_T AA_s2i_;          /**< Discrete variable "int AA.s2i". */
    real_T AA_s2r_;         /**< Discrete variable "real AA.s2r". */
    ...
    int_T AA_neg1_;         /**< Discrete variable "int AA.neg1". */
    int_T AA_neg2_;         /**< Discrete variable "int AA.neg2". */
    int_T AA_neg3_;         /**< Discrete variable "int AA.neg3". */
    int_T AA_neg4_;         /**< Discrete variable "int AA.neg4". */
    int_T AA_pos1_;         /**< Discrete variable "int AA.pos1". */
    int_T AA_pos2_;         /**< Discrete variable "int AA.pos2". */
    int_T AA_posneg_;       /**< Discrete variable "int AA.posneg". */
    A1BType AA_l3i_;        /**< Discrete variable "list[1] bool AA.l3i". */
    int_T AA_idx1_;         /**< Discrete variable "int[0..4] AA.idx1". */
    ...
    int_T AA_add1_;         /**< Discrete variable "int AA.add1". */
    real_T AA_add2_;        /**< Discrete variable "real AA.add2". */
    real_T AA_add3_;        /**< Discrete variable "real AA.add3". */
    real_T AA_add4_;        /**< Discrete variable "real AA.add4". */
    StringType AA_add5_;    /**< Discrete variable "string AA.add5". */
    int_T AA_add6_;         /**< Discrete variable "int AA.add6". */
    int_T AA_add7_;         /**< Discrete variable "int AA.add7". */
    int_T AA_add8_;         /**< Discrete variable "int AA.add8". */
    int_T AA_sub1_;         /**< Discrete variable "int AA.sub1". */
    real_T AA_sub2_;        /**< Discrete variable "real AA.sub2". */
    real_T AA_sub3_;        /**< Discrete variable "real AA.sub3". */
    real_T AA_sub4_;        /**< Discrete variable "real AA.sub4". */
    int_T AA_sub5_;         /**< Discrete variable "int AA.sub5". */
    int_T AA_sub6_;         /**< Discrete variable "int AA.sub6". */
    int_T AA_sub7_;         /**< Discrete variable "int AA.sub7". */
    int_T AA_mul1_;         /**< Discrete variable "int AA.mul1". */
    real_T AA_mul2_;        /**< Discrete variable "real AA.mul2". */
    real_T AA_mul3_;        /**< Discrete variable "real AA.mul3". */
    real_T AA_mul4_;        /**< Discrete variable "real AA.mul4". */
    int_T AA_mul5_;         /**< Discrete variable "int AA.mul5". */
    int_T AA_mul6_;         /**< Discrete variable "int AA.mul6". */
    int_T AA_mul7_;         /**< Discrete variable "int AA.mul7". */
    real_T AA_rdiv1_;       /**< Discrete variable "real AA.rdiv1". */
    real_T AA_rdiv2_;       /**< Discrete variable "real AA.rdiv2". */
    real_T AA_rdiv3_;       /**< Discrete variable "real AA.rdiv3". */
    real_T AA_rdiv4_;       /**< Discrete variable "real AA.rdiv4". */
    real_T AA_rdiv5_;       /**< Discrete variable "real AA.rdiv5". */
    real_T AA_rdiv6_;       /**< Discrete variable "real AA.rdiv6". */
    int_T AA_div1_;         /**< Discrete variable "int AA.div1". */
    int_T AA_div2_;         /**< Discrete variable "int AA.div2". */
    int_T AA_div3_;         /**< Discrete variable "int AA.div3". */
    int_T AA_div4_;         /**< Discrete variable "int AA.div4". */
    int_T AA_mod1_;         /**< Discrete variable "int AA.mod1". */
    int_T AA_mod2_;         /**< Discrete variable "int AA.mod2". */
    ...
    int_T AA_proj1_;        /**< Discrete variable "int AA.proj1". */
    int_T AA_proj2_;        /**< Discrete variable "int AA.proj2". */
    int_T AA_proj3_;        /**< Discrete variable "int AA.proj3". */
    int_T AA_proj4_;        /**< Discrete variable "int AA.proj4". */
    StringType AA_proj5_;   /**< Discrete variable "string AA.proj5". */
    StringType AA_proj6_;   /**< Discrete variable "string AA.proj6". */
    real_T AA_f_acos_;      /**< Discrete variable "real AA.f_acos". */
    real_T AA_f_asin_;      /**< Discrete variable "real AA.f_asin". */
    real_T AA_f_atan_;      /**< Discrete variable "real AA.f_atan". */
    real_T AA_f_cos_;       /**< Discrete variable "real AA.f_cos". */
    real_T AA_f_sin_;       /**< Discrete variable "real AA.f_sin". */
    real_T AA_f_tan_;       /**< Discrete variable "real AA.f_tan". */
    int_T AA_f_abs1_;       /**< Discrete variable "int AA.f_abs1". */
    int_T AA_f_abs12_;      /**< Discrete variable "int AA.f_abs12". */
    real_T AA_f_abs2_;      /**< Discrete variable "real AA.f_abs2". */
    real_T AA_f_cbrt_;      /**< Discrete variable "real AA.f_cbrt". */
    int_T AA_f_ceil_;       /**< Discrete variable "int AA.f_ceil". */
    BoolType AA_f_empty_;   /**< Discrete variable "bool AA.f_empty". */
    real_T AA_f_exp_;       /**< Discrete variable "real AA.f_exp". */
    int_T AA_f_floor_;      /**< Discrete variable "int AA.f_floor". */
    real_T AA_f_ln_;        /**< Discrete variable "real AA.f_ln". */
    real_T AA_f_log_;       /**< Discrete variable "real AA.f_log". */
    int_T AA_f_max1_;       /**< Discrete variable "int AA.f_max1". */
    real_T AA_f_max2_;      /**< Discrete variable "real AA.f_max2". */
    real_T AA_f_max3_;      /**< Discrete variable "real AA.f_max3". */
    real_T AA_f_max4_;      /**< Discrete variable "real AA.f_max4". */
    int_T AA_f_min1_;       /**< Discrete variable "int AA.f_min1". */
    real_T AA_f_min2_;      /**< Discrete variable "real AA.f_min2". */
    real_T AA_f_min3_;      /**< Discrete variable "real AA.f_min3". */
    real_T AA_f_min4_;      /**< Discrete variable "real AA.f_min4". */
    real_T AA_f_pow1_;      /**< Discrete variable "real AA.f_pow1". */
    int_T AA_f_pow12_;      /**< Discrete variable "int AA.f_pow12". */
    real_T AA_f_pow2_;      /**< Discrete variable "real AA.f_pow2". */
    real_T AA_f_pow3_;      /**< Discrete variable "real AA.f_pow3". */
    real_T AA_f_pow4_;      /**< Discrete variable "real AA.f_pow4". */
    int_T AA_f_round_;      /**< Discrete variable "int AA.f_round". */
    real_T AA_f_scale_;     /**< Discrete variable "real AA.f_scale". */
    int_T AA_f_sign1_;      /**< Discrete variable "int AA.f_sign1". */
    int_T AA_f_sign2_;      /**< Discrete variable "int AA.f_sign2". */
    int_T AA_f_size1_;      /**< Discrete variable "int AA.f_size1". */
