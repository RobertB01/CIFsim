...
# EVENT_OUTPUT
# If set, performed events are reported to fmt_EventOutput
...
gcc $CFLAGS -c -o fmt_library.o fmt_library.c
gcc $CFLAGS -c -o fmt_engine.o fmt_engine.c
gcc $CFLAGS -c -o fmt_test_code.o fmt_test_code.c
gcc $CFLAGS -o fmt_engine_test fmt_test_code.o fmt_engine.o fmt_library.o $LFLAGS
