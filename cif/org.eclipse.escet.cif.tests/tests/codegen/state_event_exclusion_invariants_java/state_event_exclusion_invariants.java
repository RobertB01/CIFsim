...
/** state_event_exclusion_invariants code generated from a CIF specification. */
@SuppressWarnings("unused")
public abstract class state_event_exclusion_invariants {
    ...
    /** Constructor for the {@link state_event_exclusion_invariants} class. */
    public state_event_exclusion_invariants() {
        firstExec = true;
        this.time = 0.0;
    }
     ...
     *      execution.
     * @throws state_event_exclusion_invariantsException In case of a runtime error caused by code
    ...
    /**
     * state_event_exclusion_invariants exception.
     *
     * <p>Indices a runtime error while executing the generated code.</p>
     */
    public static class state_event_exclusion_invariantsException extends RuntimeException {
        /**
         * Constructor for the {@link state_event_exclusion_invariantsException} class.
         *
         * @param message The message describing the exception.
         */
        public state_event_exclusion_invariantsException(String message) {
            super(message);
        }
         ...
         */
        public state_event_exclusion_invariantsException(String message, Throwable cause) {
            super(message, cause);
        }
    ...
    public static class state_event_exclusion_invariantsUtils {
         ...
         * @return {@code abs(x)}.
         * @throws state_event_exclusion_invariantsException If the operation results in integer
         *      overflow.
         */
        public static int abs(int x) {
            if (x == Integer.MIN_VALUE) {
                String msg = fmt("Integer overflow: abs(%d).", x);
                throw new state_event_exclusion_invariantsException(msg);
            }
            return Math.abs(x);
        }
         ...
         * @param x The real number.
         * @return {@code acos(x)}.
         * @throws state_event_exclusion_invariantsException If the operation results in real overflow,
         *      or {@code NaN}.
         */
        ...
        */
         ...
         * @param x The real number.
         * @return {@code ln(x)}.
         * @throws state_event_exclusion_invariantsException If the real number is non-positive.
         */
         ...
         * @param y The divisor.
         * @return {@code x mod y}.
         * @throws state_event_exclusion_invariantsException If the operation results in division by
         *      zero.
         */
         ...
         * @throws state_event_exclusion_invariantsException If the index is out of range for the list.
         */
         ...
         * @throws state_event_exclusion_invariantsException If the index is out of range for the
         *      string.
         */
         ...
         *      as end-user readable text.
         * @throws state_event_exclusion_invariantsException Always thrown.
         */
         ...
         * @throws state_event_exclusion_invariantsException If the input interval is empty, or the
         ...
         * @param x The real number.
         * @return {@code sqrt(x)}.
         * @throws state_event_exclusion_invariantsException If the real number is negative.
         */
         ...
         * @throws state_event_exclusion_invariantsException If the string value does not represent a
         *      boolean value.
         */
         ...
         * @throws state_event_exclusion_invariantsException If the string value does not represent an
         *      integer value.
         */
        ...
        public static String valueToStr(Object value) {
            ...
            } else if (value instanceof state_event_exclusion_invariants.CifTupleBase) {
                return value.toString();
