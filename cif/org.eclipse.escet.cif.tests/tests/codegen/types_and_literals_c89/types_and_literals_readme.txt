The 'types_and_literals_*' files here are generated using the CIF to C89 code generator.
Below is a description of what it contains, and how to use and/or tailor them
towards your wishes.

Generated files
===============
* types_and_literals_library.c and types_and_literals_library.h
...
* types_and_literals_engine.c and types_and_literals_engine.h
...
* types_and_literals_AssignInputVariables(void)
...
* types_and_literals_InfoEvent(types_and_literals_Event_ event, BoolType pre)
  Announcement or report of an event taking place. Can be disabled with a
  compile-time flag.

* types_and_literals_PrintOutput(const char *line, const char *fname)
...
* EVENT_OUTPUT
  ...
  external "types_and_literals_InfoEvent" function. There is no CIF equivalent of this
  function.

* PRINT_OUTPUT
  If true (-DPRINT_OUTPUT=1), print statements are performed as specified in
  CIF. The results are routed to the external "types_and_literals_PrintOutput" function.
