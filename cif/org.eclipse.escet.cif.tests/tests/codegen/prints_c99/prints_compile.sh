...
# PRINT_OUTPUT
# If set, 'print' statements are forwarded to prints_PrintOutput.

# EVENT_OUTPUT
# If set, performed events are reported to prints_EventOutput
...
gcc $CFLAGS -c -o prints_library.o prints_library.c
gcc $CFLAGS -c -o prints_engine.o prints_engine.c
gcc $CFLAGS -c -o prints_test_code.o prints_test_code.c
gcc $CFLAGS -o prints_engine_test prints_test_code.o prints_engine.o prints_library.o $LFLAGS
