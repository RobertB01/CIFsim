...
/** Test class for the {@link databased_supervisor} class. */
@SuppressWarnings("unused")
public class databased_supervisorTest extends databased_supervisor {
    /**
     * Main method for the {@link databased_supervisorTest} class.
     *
     * @param args The command line arguments. Ignored.
     */
    public static void main(String[] args) {
        databased_supervisor code = new databased_supervisorTest();
        code.exec(100);
    }
