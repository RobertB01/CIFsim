...
/** rename_warning code generated from a CIF specification. */
@SuppressWarnings("unused")
public abstract class rename_warning {
    ...
    /** Constant "a_b". */
    public static final int a_b_ = 5;

    /** Constant "a.b". */
    public static final int a_b_2 = 6;
     ...
     *      execution.
     * @throws rename_warningException In case of a runtime error caused by code
     ...
     *      as file separators. Use {@link rename_warningUtils#normalizePrintTarget}
    ...
    /**
     * rename_warning exception.
     *
     * <p>Indices a runtime error while executing the generated code.</p>
     */
    public static class rename_warningException extends RuntimeException {
        /**
         * Constructor for the {@link rename_warningException} class.
         *
         * @param message The message describing the exception.
         */
        public rename_warningException(String message) {
            super(message);
        }
         ...
         */
        public rename_warningException(String message, Throwable cause) {
            super(message, cause);
        }
    ...
    /** {@link rename_warning} utility code. */
    public static class rename_warningUtils {
        /** The file separator for the current platform. */
        private static final String FILE_SEPARATOR = System.getProperty("file.separator");

        /** Constructor for the {@link rename_warningUtils} class. */
        private rename_warningUtils() {
            // Static class.
        }
         ...
         * @return {@code abs(x)}.
         * @throws rename_warningException If the operation results in integer
         *      overflow.
         */
        public static int abs(int x) {
            if (x == Integer.MIN_VALUE) {
                String msg = fmt("Integer overflow: abs(%d).", x);
                throw new rename_warningException(msg);
            }
            return Math.abs(x);
        }
         ...
         * @param x The real number.
         * @return {@code acos(x)}.
         * @throws rename_warningException If the operation results in real overflow,
         *      or {@code NaN}.
         */
        ...
        */
         ...
         * @param x The real number.
         * @return {@code ln(x)}.
         * @throws rename_warningException If the real number is non-positive.
         */
         ...
         * @param y The divisor.
         * @return {@code x mod y}.
         * @throws rename_warningException If the operation results in division by
         *      zero.
         */
         ...
         * @throws rename_warningException If the index is out of range for the list.
         */
         ...
         * @throws rename_warningException If the index is out of range for the
         *      string.
         */
         ...
         *      as end-user readable text.
         * @throws rename_warningException Always thrown.
         */
         ...
         * @throws rename_warningException If the input interval is empty, or the
         ...
         * @param x The real number.
         * @return {@code sqrt(x)}.
         * @throws rename_warningException If the real number is negative.
         */
         ...
         * @throws rename_warningException If the string value does not represent a
         *      boolean value.
         */
         ...
         * @throws rename_warningException If the string value does not represent an
         *      integer value.
         */
        ...
        public static String valueToStr(Object value) {
            ...
            } else if (value instanceof rename_warning.CifTupleBase) {
                return value.toString();
