The 'various_*' files here are generated using the CIF to C89 code generator.
Below is a description of what it contains, and how to use and/or tailor them
towards your wishes.

Generated files
===============
* various_library.c and various_library.h
...
* various_engine.c and various_engine.h
...
* various_AssignInputVariables(void)
...
* various_InfoEvent(various_Event_ event, BoolType pre)
  Announcement or report of an event taking place. Can be disabled with a
  compile-time flag.

* various_PrintOutput(const char *line, const char *fname)
...
* EVENT_OUTPUT
  ...
  external "various_InfoEvent" function. There is no CIF equivalent of this
  function.

* PRINT_OUTPUT
  If true (-DPRINT_OUTPUT=1), print statements are performed as specified in
  CIF. The results are routed to the external "various_PrintOutput" function.
