...
public abstract class various {
    ...
    public List<Integer> input_li_;

    /** Constructor for the {@link various} class. */
    public various() {
        firstExec = true;
        this.time = 0.0;
    }
    ...
    public void execOnce(double newTime) {
        ...
        if (!firstExec) {
            double deriv0 = g_sync_c_deriv();

            g_sync_c_ = g_sync_c_ + delta * deriv0;
            checkDouble(g_sync_c_, "g.sync.c");
            if (g_sync_c_ == -0.0) g_sync_c_ = 0.0;
        }
    ...
    private boolean execEvent1() {
        ...
        g_rcv_v_ = multiply(g_rcv_v2_, addInt(z_(), g_snd_a_));
        g_snd_a_ = addInt(g_snd_a_, 1);
        g_sync_c_ = 0.0;
    ...
    private void printOutput(int idx, boolean pre) {
        ...
        if (true) {
            if (!pre) {
                String text = "file";
                infoPrintOutput(text, ".\\some_file.txt");
            }
        }
    }
     ...
     *      as path separators. Use {@link variousUtils#normalizePrintTarget}
     ...
     */
    public static class variousException extends RuntimeException {
        /**
         * Constructor for the {@link variousException} class.
         *
         * @param message The message describing the exception.
         */
        public variousException(String message) {
            super(message);
        }
         ...
         */
        public variousException(String message, Throwable cause) {
            super(message, cause);
        }
    ...
    /** {@link various} utility code. */
    public static class variousUtils {
        /** The path separator for the current platform. */
        private static final String PATH_SEPARATOR = System.getProperty("file.separator");

        /** Constructor for the {@link variousUtils} class. */
         ...
         * @return {@code abs(x)}.
         * @throws variousException If the operation results in integer
         *      overflow.
         */
        public static int abs(int x) {
            if (x == Integer.MIN_VALUE) {
                String msg = fmt("Integer overflow: abs(%d).", x);
                throw new variousException(msg);
            }
            return Math.abs(x);
        }
         ...
         * @param x The real number.
         * @return {@code acos(x)}.
         * @throws variousException If the operation results in real overflow,
         *      or {@code NaN}.
         */
        ...
        */
         ...
         * @param x The real number.
         * @return {@code ln(x)}.
         * @throws variousException If the real number is non-positive.
         */
         ...
         * @param y The divisor.
         * @return {@code x mod y}.
         * @throws variousException If the operation results in division by
         *      zero.
         */
         ...
         * @throws variousException If the index is out of range for the list.
         */
         ...
         * @throws variousException If the index is out of range for the
         *      string.
         */
         ...
         *      as end-user readable text.
         * @throws variousException Always thrown.
         */
         ...
         * @throws variousException If the input interval is empty, or the
         ...
         * @param x The real number.
         * @return {@code sqrt(x)}.
         * @throws variousException If the real number is negative.
         */
         ...
         * @throws variousException If the string value does not represent a
         *      boolean value.
         */
         ...
         * @throws variousException If the string value does not represent an
         *      integer value.
         */
        ...
        public static String valueToStr(Object value) {
            ...
            } else if (value instanceof various.CifTupleBase) {
                return value.toString();
