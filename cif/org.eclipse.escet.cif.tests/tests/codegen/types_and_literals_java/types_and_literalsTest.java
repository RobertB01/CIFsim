...
/** Test class for the {@link types_and_literals} class. */
@SuppressWarnings("unused")
public class types_and_literalsTest extends types_and_literals {
    /**
     * Main method for the {@link types_and_literalsTest} class.
     *
     * @param args The command line arguments. Ignored.
     */
    public static void main(String[] args) {
        types_and_literals code = new types_and_literalsTest();
        code.exec(100);
    }
