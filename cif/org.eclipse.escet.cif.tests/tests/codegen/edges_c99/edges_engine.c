...
IntType aut14_i_; /**< Input variable "int aut14.i". */
...
void edges_EngineTimeStep(double delta) {
    ...
    if (delta > 0.0) {
        ...
        aut03_c_ = UpdateContValue(aut03_c_ + delta * deriv0, "aut03.c");
        aut07_x_ = UpdateContValue(aut07_x_ + delta * deriv1, "aut07.x");
        aut07_y_ = UpdateContValue(aut07_y_ + delta * deriv2, "aut07.y");
        aut12_t_ = UpdateContValue(aut12_t_ + delta * deriv3, "aut12.t");
        aut12_u_ = UpdateContValue(aut12_u_ + delta * deriv4, "aut12.u");
        model_time += delta;
    }
