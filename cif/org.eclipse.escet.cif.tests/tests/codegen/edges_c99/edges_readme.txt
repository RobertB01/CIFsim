The 'edges_*' files here are generated using the CIF to C99 code generator.
Below is a description of what it contains, and how to use and/or tailor them
towards your wishes.

Generated files
===============
* edges_library.c and edges_library.h
...
* edges_engine.c and edges_engine.h
...
* edges_AssignInputVariables(void)
...
* edges_InfoEvent(edges_Event_ event, BoolType pre)
  Announcement or report of an event taking place. Can be disabled with a
  compile-time flag.

* edges_PrintOutput(const char *line, const char *fname)
...
* EVENT_OUTPUT
  ...
  external "edges_InfoEvent" function. There is no CIF equivalent of this
  function.

* PRINT_OUTPUT
  If true (-DPRINT_OUTPUT=1), print statements are performed as specified in
  CIF. The results are routed to the external "edges_PrintOutput" function.
