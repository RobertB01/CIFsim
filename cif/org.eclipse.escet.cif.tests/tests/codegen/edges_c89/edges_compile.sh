...
# PRINT_OUTPUT
# If set, 'print' statements are forwarded to edges_PrintOutput.

# EVENT_OUTPUT
# If set, performed events are reported to edges_EventOutput
...
gcc $CFLAGS -c -o edges_library.o edges_library.c
gcc $CFLAGS -c -o edges_engine.o edges_engine.c
gcc $CFLAGS -c -o edges_test_code.o edges_test_code.c
gcc $CFLAGS -o edges_engine_test edges_test_code.o edges_engine.o edges_library.o $LFLAGS
