The 'internal_functions_*' files here are generated using the CIF to C89 code generator.
Below is a description of what it contains, and how to use and/or tailor them
towards your wishes.

Generated files
===============
* internal_functions_library.c and internal_functions_library.h
...
* internal_functions_engine.c and internal_functions_engine.h
...
* internal_functions_AssignInputVariables(void)
...
* internal_functions_InfoEvent(internal_functions_Event_ event, BoolType pre)
  Announcement or report of an event taking place. Can be disabled with a
  compile-time flag.

* internal_functions_PrintOutput(const char *line, const char *fname)
...
* EVENT_OUTPUT
  ...
  external "internal_functions_InfoEvent" function. There is no CIF equivalent of this
  function.

* PRINT_OUTPUT
  If true (-DPRINT_OUTPUT=1), print statements are performed as specified in
  CIF. The results are routed to the external "internal_functions_PrintOutput" function.
