The 'declarations_*' files here are generated using the CIF to C89 code generator.
Below is a description of what it contains, and how to use and/or tailor them
towards your wishes.

Generated files
===============
* declarations_library.c and declarations_library.h
...
* declarations_engine.c and declarations_engine.h
...
* declarations_AssignInputVariables(void)
...
* declarations_InfoEvent(declarations_Event_ event, BoolType pre)
  Announcement or report of an event taking place. Can be disabled with a
  compile-time flag.

* declarations_PrintOutput(const char *line, const char *fname)
...
* EVENT_OUTPUT
  ...
  external "declarations_InfoEvent" function. There is no CIF equivalent of this
  function.

* PRINT_OUTPUT
  If true (-DPRINT_OUTPUT=1), print statements are performed as specified in
  CIF. The results are routed to the external "declarations_PrintOutput" function.
