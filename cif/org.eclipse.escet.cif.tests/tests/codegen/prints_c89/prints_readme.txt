The 'prints_*' files here are generated using the CIF to C89 code generator.
Below is a description of what it contains, and how to use and/or tailor them
towards your wishes.

Generated files
===============
* prints_library.c and prints_library.h
...
* prints_engine.c and prints_engine.h
...
* prints_AssignInputVariables(void)
...
* prints_InfoEvent(prints_Event_ event, BoolType pre)
  Announcement or report of an event taking place. Can be disabled with a
  compile-time flag.

* prints_PrintOutput(const char *line, const char *fname)
...
* EVENT_OUTPUT
  ...
  external "prints_InfoEvent" function. There is no CIF equivalent of this
  function.

* PRINT_OUTPUT
  If true (-DPRINT_OUTPUT=1), print statements are performed as specified in
  CIF. The results are routed to the external "prints_PrintOutput" function.
