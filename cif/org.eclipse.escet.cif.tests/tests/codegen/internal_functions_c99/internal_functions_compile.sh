...
# PRINT_OUTPUT
# If set, 'print' statements are forwarded to internal_functions_PrintOutput.

# EVENT_OUTPUT
# If set, performed events are reported to internal_functions_EventOutput
...
gcc $CFLAGS -c -o internal_functions_library.o internal_functions_library.c
gcc $CFLAGS -c -o internal_functions_engine.o internal_functions_engine.c
gcc $CFLAGS -c -o internal_functions_test_code.o internal_functions_test_code.c
gcc $CFLAGS -o internal_functions_engine_test internal_functions_test_code.o internal_functions_engine.o internal_functions_library.o $LFLAGS
