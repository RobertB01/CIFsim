...
/**
 * {@link ExprNoSpecificBinaryExprsCheck} with all level 4 and higher disalloweds enabled. *
 *
 * <p>
...
public class ExprNoSpecificBinaryExprsCheckLevel4 extends ExprNoSpecificBinaryExprsCheck {
    /** Constructor for the {@link ExprNoSpecificBinaryExprsCheckLevel4} class. */
    public ExprNoSpecificBinaryExprsCheckLevel4() {
        super(Arrays.stream(NoSpecificBinaryOp.values()).filter(v -> StringUtils.countMatches(v.name(), "_") >= 4)
