...
/**
 * {@link FuncNoSpecificStdLibCheck} with all level 1 disalloweds enabled. The {@code ALL_*} disalloweds are excluded.
 *
 * <p>
...
public class FuncNoSpecificStdLibCheckLevel1 extends FuncNoSpecificStdLibCheck {
    /** Constructor for the {@link FuncNoSpecificStdLibCheckLevel1} class. */
    public FuncNoSpecificStdLibCheckLevel1() {
        super(Arrays.stream(NoSpecificStdLib.values()).filter(v -> StringUtils.countMatches(v.name(), "_") == 1)
