...
/**
 * {@link FuncNoSpecificStdLibCheck} with all level 0 disalloweds enabled. The {@code ALL_*} disalloweds are excluded.
 *
 * <p>
...
public class FuncNoSpecificStdLibCheckLevel0 extends FuncNoSpecificStdLibCheck {
    /** Constructor for the {@link FuncNoSpecificStdLibCheckLevel0} class. */
    public FuncNoSpecificStdLibCheckLevel0() {
        super(Arrays.stream(NoSpecificStdLib.values()).filter(v -> StringUtils.countMatches(v.name(), "_") == 0)
