...
/** Annotation provider for the 'cif:typechecker:tests:anno3' annotation. */
public class Anno3Provider extends AnnotationProvider {
    /**
     * Constructor for the {@link Anno3Provider} class.
     *
     * @param annotationName The name of the annotations handled by this annotation provider.
     */
    public Anno3Provider(String annotationName) {
