...
/**
 * {@link FuncNoSpecificStdLibCheck} with all level 3 and higher disalloweds enabled. The {@code ALL_*} disalloweds are
 * excluded.
 *
 * <p>
...
public class FuncNoSpecificStdLibCheckLevel3 extends FuncNoSpecificStdLibCheck {
    /** Constructor for the {@link FuncNoSpecificStdLibCheckLevel3} class. */
    public FuncNoSpecificStdLibCheckLevel3() {
        super(Arrays.stream(NoSpecificStdLib.values()).filter(v -> StringUtils.countMatches(v.name(), "_") >= 3)
