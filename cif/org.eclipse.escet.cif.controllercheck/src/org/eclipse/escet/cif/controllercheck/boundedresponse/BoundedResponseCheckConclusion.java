...
public class BoundedResponseCheckConclusion implements CheckConclusion {
    /**
     * The bound on the number of uncontrollable events per cycle. Is {@code -1} if the system can not be initialized, a
    ...
    /**
     * The bound on the number of controllable events per cycle. Is {@code -1} if the system can not be initialized, a
     * non-negative integer indicating the bound if it has bounded response, and {@code null} if it does not have
     * bounded response.
     */
     ...
     *     system can not be initialized, a non-negative integer indicating the bound if it has bounded response, and
     ...
     *     can not be initialized, a non-negative integer indicating the bound if it has bounded response, and
     *     {@code null} if it does not have bounded response.
     */
