...
/** Type information object for the CIF boolean type in the C89 target language. */
public class C89BoolTypeInfo extends BoolTypeInfo implements C89TypeInfo {
    /**
    ...
    /**
     * Constructor for {@link C89BoolTypeInfo} class.
     *
     ...
     */
    public C89BoolTypeInfo(boolean genLocalFunctions, CifType cifType) {
        super(cifType);
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof C89BoolTypeInfo;
    }

    @Override
    public int hashCode() {
        return C89BoolTypeInfo.class.hashCode();
    }
}
