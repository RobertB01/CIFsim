...
public abstract class TypeInfo {
    ...
    public ExprCode convertEqualsExpression(BinaryExpression expr, Destination dest, CodeContext ctxt) {
        return convertBinaryExpressionPattern(expr, getBinaryExpressionTemplate(BinaryOperator.EQUAL), dest, ctxt);
    }
    ...
    public ExprCode convertUnequalsExpression(BinaryExpression expr, Destination dest, CodeContext ctxt) {
        return convertBinaryExpressionPattern(expr, getBinaryExpressionTemplate(BinaryOperator.UNEQUAL), dest, ctxt);
    }
     ...
     */
    public abstract String getBinaryExpressionTemplate(BinaryOperator binOp);
