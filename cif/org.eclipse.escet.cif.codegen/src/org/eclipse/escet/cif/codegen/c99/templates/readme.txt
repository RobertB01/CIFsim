The '${prefix}_*' files here are generated using the CIF to C99 code generator.
Below is a description of what it contains, and how to use and/or tailor them
towards your wishes.

Generated files
===============
* ${prefix}_library.c and ${prefix}_library.h
...
* ${prefix}_engine.c and ${prefix}_engine.h
...
* EVENT_OUTPUT
  ...
  external "${prefix}_InfoEvent" function. There is no CIF equivalent of this
  function.

* PRINT_OUTPUT
  If true (-DPRINT_OUTPUT=1), print statements are performed as specified in
  CIF. The results are routed to the external "${prefix}_PrintOutput" function.
