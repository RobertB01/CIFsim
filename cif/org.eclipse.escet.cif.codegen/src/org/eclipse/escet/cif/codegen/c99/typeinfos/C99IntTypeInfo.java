...
/**
 * Type information object for the CIF int type in the C99 target language.
 *
 * <p>
 * Integer ranges are ignored in the C99 target.
 * </p>
 */
public class C99IntTypeInfo extends IntTypeInfo implements C99TypeInfo {
    /**
    ...
    /**
     * Constructor for {@link C99IntTypeInfo} class.
     *
     ...
     */
    public C99IntTypeInfo(boolean genLocalFunctions, CifType cifType) {
        super(cifType);
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof C99IntTypeInfo;
    }

    @Override
    public int hashCode() {
        return C99IntTypeInfo.class.hashCode();
    }
