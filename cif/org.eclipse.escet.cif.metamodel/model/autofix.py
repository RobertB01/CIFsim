...
# Set base package.
genmodel_content = genmodel_content.replace(
    '<genPackages prefix="Cif"',
    '<genPackages prefix="Cif" basePackage="org.eclipse.escet.cif.metamodel"'
)

# Set file extension.
genmodel_content = genmodel_content.replace(
    'ecorePackage="cif.ecore#/">',
    'fileExtensions="cifx" ecorePackage="cif.ecore#/">'
)
...
genmodel_content = genmodel_content.replace(
    '/GenModel"',
    '/GenModel" copyrightText="Copyright (c) 2010, 2023 Contributors to the Eclipse Foundation&#xA;&#xA;See the NOTICE file(s) distributed with this work for additional&#xA;information regarding copyright ownership.&#xA;&#xA;This program and the accompanying materials are made available under the terms&#xA;of the MIT License which is available at https://opensource.org/licenses/MIT&#xA;&#xA;SPDX-License-Identifier: MIT&#xA;&#xA;Disable Eclipse Java formatter for generated code file:&#xA;@formatter:off"'
)
...
genmodel_content = genmodel_content.replace(
    'basePackage="org.eclipse.escet.cif.metamodel" disposableProviderFactory="true" ',
    'basePackage="org.eclipse.escet.cif.metamodel" disposableProviderFactory="true"\n      '
)
