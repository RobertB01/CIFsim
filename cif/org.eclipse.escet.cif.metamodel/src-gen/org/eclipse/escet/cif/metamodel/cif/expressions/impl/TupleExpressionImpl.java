 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.escet.cif.metamodel.cif.expressions.impl.TupleExpressionImpl#getFields <em>Fields</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleExpressionImpl extends ExpressionImpl implements TupleExpression
{
    ...
    public EList<Expression> getFields()
    {
        if (fields == null)
        {
            fields = new EObjectContainmentEList<Expression>(Expression.class, this, ExpressionsPackage.TUPLE_EXPRESSION__FIELDS);
        }
        return fields;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case ExpressionsPackage.TUPLE_EXPRESSION__FIELDS:
