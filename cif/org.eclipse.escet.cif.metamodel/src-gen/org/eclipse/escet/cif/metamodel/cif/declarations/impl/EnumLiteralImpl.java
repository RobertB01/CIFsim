 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.escet.cif.metamodel.cif.declarations.impl.EnumLiteralImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumLiteralImpl extends PositionObjectImpl implements EnumLiteral
{
    ...
    {
        return DeclarationsPackage.Literals.ENUM_LITERAL;
    }
    ...
    public void setName(String newName)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DeclarationsPackage.ENUM_LITERAL__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case DeclarationsPackage.ENUM_LITERAL__NAME:
                return getName();
        }
