...
Note that tuple projection expressions, introduce a sub-scope. This scope has
...
Note If it is a field reference, the textual reference to that field must be a
single identifier. For instance, for a tuple-typed variable \texttt{t},
