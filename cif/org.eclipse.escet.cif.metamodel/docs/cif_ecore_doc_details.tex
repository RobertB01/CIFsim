...
\citem{Assignment.variablesInScope}
  ...
  this assignment update.  Discrete and continuous variables may be mixed in a
  single assignment.
\end{constraints}
}
...
\begin{constraints}
\citem{AnnotatedObject.uniqueAnnotations}
  The names of each of the annotations must be unique within the annotated
  object.
\citem{AnnotatedObject.onlyForInputVariables}
  For now, only input variables may have annotations. This restriction may be
  removed or relaxed in the future.
\end{constraints}
}
