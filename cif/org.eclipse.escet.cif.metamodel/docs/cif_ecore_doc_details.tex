...
\citem{Assignment.variablesInScope}
  The variables that are assigned must be discrete or continuous variables
...
\citem{SvgIn.uniqueVariables}
  ...
  evaluate and normalize the indices. See the 'Edge.uniqueVariables' constraint
  for the complete details.
\citem{SvgIn.variablesInScope}
  The variables that are assigned must be input variables.
\end{constraints}
}
