...
This package contains the \cifclass{Annotation} class to represent annotations,
and the \cifclass{AnnotationArgument} class to represent arguments of
annotations.
}
...
\begin{constraints}
\citem{Annotation.unique}
  If multiple annotations are provided for a single object, the annotations
