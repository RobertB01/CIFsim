...
\citem{Assignment.addressableSyntax}
  ...
  (non-wrapped) with projections and addressables in CIF/SVG input mapping may
...
\citem{Assignment.variablesInScope}
  ...
  in a single assignment. The variables that are assigned in CIF/SVG input mapping
