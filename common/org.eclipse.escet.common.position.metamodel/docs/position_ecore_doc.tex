...
\input{ecore_diagrams.tex}


\section{Metamodel documentation conventions}

\input{ecore_doc_conventions.tex}
...
\input{position_ecore_doc_details.tex}
\input{position_ecore_doc_generated.tex}
