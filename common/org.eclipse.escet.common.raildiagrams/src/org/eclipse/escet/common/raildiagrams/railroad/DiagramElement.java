...
/**
 * A (rectangular) part of a railroad diagram, also acts as the edges of its
 * contents.
 */
public abstract class DiagramElement {
     ...
     * @return The proxied element with variables from the element environment. Use
     *         this for connecting the child element to other parts of the diagram
     *         here.
     */
     ...
     * @param direction Direction of flow through the node, positive is left to
     *                  right, negative is right to left.
     */
