...
public class PaintSupport {
    ...
    public static void setLineWidth(Graphics2D gd, int width) {
        if (width < 1) width = 1; // Make sure the line is shown.
     ...
     */
    public static void drawArc(Graphics2D gd, double xpos, double ypos, ArcType arcType,
                               double size, double lineWidth, Color color)
    {
        gd.setColor(color);
        ...
        gd.drawArc(arcX, arcY, (int)(2 * size - 2 * lineWidth), (int)(2 * size - 2 * lineWidth),
                   arcType.startAngle, 90);

    }

    public static enum ArcType {
        /** Bottom-left arc. */  BL_ARC(180,  0, 0.5, -1, 1.5),
        /** Bottom-right arc. */ BR_ARC(270, -1, 1.5, -1, 1.5),
        /** Top-left arc. */     TL_ARC(90,   0, 0.5,  0, 0.5),
        /** Top-right arc. */    TR_ARC(0,   -1, 1.5,  0, 0.5);
