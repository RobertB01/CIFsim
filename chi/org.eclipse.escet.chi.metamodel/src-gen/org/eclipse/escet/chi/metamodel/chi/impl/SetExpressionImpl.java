 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.escet.chi.metamodel.chi.impl.SetExpressionImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetExpressionImpl extends ExpressionImpl implements SetExpression
{
    ...
    {
        return ChiPackage.Literals.SET_EXPRESSION;
    }
    ...
    public EList<Expression> getElements()
    {
        if (elements == null)
        {
            elements = new EObjectContainmentEList<Expression>(Expression.class, this, ChiPackage.SET_EXPRESSION__ELEMENTS);
        }
        return elements;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case ChiPackage.SET_EXPRESSION__ELEMENTS:
