...
The definition of those parameters are called _formal parameters_, The syntax of formal parameters is shown below
...
The formal parameters introduce additional variables in the process, that can be just just like any other variable.
