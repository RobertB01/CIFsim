...
image::{ref-imgsdir}/rail_diagrams/body.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/statement.rr.png[]
...
The syntax diagram of `Body` states that statements are separated from each other with a semicolon (`;`).
The compiler allows more freedom.
Semicolons may be omitted before and after a `end` keyword, and a semicolon may be added after the last statement.
...
image::{ref-imgsdir}/rail_diagrams/vardef.rr.png[]
...
Use a semicolon to terminate the sequence of new variables.
...
image::{ref-imgsdir}/rail_diagrams/assignment_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/addressable.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/iterative_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/while_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/for_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/break_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/continue_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/choice_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/subprocess_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/run_start.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/process_instance.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/finish_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/communication_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/send_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/receive_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/select_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/select_condition.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/select_alternative.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/other_statements.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/delay_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/write_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/close_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/return_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/exit_statement.rr.png[]
...
image::{ref-imgsdir}/rail_diagrams/pass_statement.rr.png[]
