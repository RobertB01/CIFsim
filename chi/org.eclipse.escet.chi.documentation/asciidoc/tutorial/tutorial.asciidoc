...
* _Basics_: Elementary knowledge needed for writing and understanding Chi
programs. _Start here to learn the language!_

** <<tut-chapter-data-types,Data types>> (explanation of all kinds of data and their
operations)
...
* _Programming_: How to specify parallel executing processes using the Chi
language.
...
* _Visualization_: Making an animated graphical display of a system with the
Chi simulator.
