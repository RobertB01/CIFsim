...
An assembly work station for two components is shown in <<tut-figure-assembly-two-components>>.
...
A generalized assembly work station for `n` components is depicted in <<tut-figure-assembly-n-components>>.
