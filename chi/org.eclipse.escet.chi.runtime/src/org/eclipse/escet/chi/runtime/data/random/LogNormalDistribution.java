...
/**
 * Class containing a stochastic lognormal distribution.
 *
 * <p>
 * LN(m, v2)
 * <ul>
...
public class LogNormalDistribution extends DoubleDistribution {
    ...
    /**
     * Constructor of the {@link LogNormalDistribution} class.
     *
    ...
    public LogNormalDistribution(ChiCoordinator chiCoordinator, double mean, double variance) {
        ...
        if (variance <= 0.0) {
            String msg = fmt("The Lognormal distribution expects the variance parameter to be bigger than 0, "
    ...
    public double sample() {
        double normSample = gausGen.drawGaussian(mean, sqrtVariance);
