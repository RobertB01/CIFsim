...
The release notes for the releases of ToolDef and the associated tools, as
...
- We no longer use separate language and tool versions. The `.tooldef2` file
extension has been changed to `.tooldef` as part of this change.
