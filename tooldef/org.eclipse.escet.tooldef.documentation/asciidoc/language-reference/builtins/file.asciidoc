...
In case `lines` are given, new line will additionally be written after each line of text.
...
All new lines in the given `text` or `lines` are replaced by the new lines of the current platform.
The new lines of the current platform are also used after each of the `lines`.
...
| Any other value
| Write the text or lines of text with the given new lines.
All new lines in the given `text` or `lines` are replaced by the given new line text.
The given new line text is also used after each of the `lines`.
|===
