...
If executed from an Eclipse-based IDE, the class is loaded using the class loader of the given bundle (if provided), otherwise, it is loaded using the default class loader.
