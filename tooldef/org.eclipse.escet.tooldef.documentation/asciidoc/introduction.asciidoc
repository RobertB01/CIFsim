...
* The type system is compatible with link:http://oracle.com/java[Java], allowing easy integration with existing Java code.
...
* Easy to extend with new tools, written in ToolDef itself, or in link:http://oracle.com/java[Java].
