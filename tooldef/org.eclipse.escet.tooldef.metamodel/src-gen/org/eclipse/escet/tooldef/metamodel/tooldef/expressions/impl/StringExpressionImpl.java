 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.escet.tooldef.metamodel.tooldef.expressions.impl.StringExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringExpressionImpl extends ExpressionImpl implements StringExpression
{
    ...
    public void setValue(String newValue)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.STRING_EXPRESSION__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case ExpressionsPackage.STRING_EXPRESSION__VALUE:
                return getValue();
        }
