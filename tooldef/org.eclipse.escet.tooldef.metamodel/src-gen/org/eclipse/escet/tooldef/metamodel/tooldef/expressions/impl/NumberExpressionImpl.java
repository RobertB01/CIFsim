 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.escet.tooldef.metamodel.tooldef.expressions.impl.NumberExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberExpressionImpl extends ExpressionImpl implements NumberExpression
{
    ...
    {
        return ExpressionsPackage.Literals.NUMBER_EXPRESSION;
    }
    ...
    public void setValue(String newValue)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.NUMBER_EXPRESSION__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case ExpressionsPackage.NUMBER_EXPRESSION__VALUE:
                return getValue();
        }
