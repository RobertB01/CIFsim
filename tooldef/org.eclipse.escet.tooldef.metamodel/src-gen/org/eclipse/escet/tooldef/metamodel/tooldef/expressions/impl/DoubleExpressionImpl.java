 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.escet.tooldef.metamodel.tooldef.expressions.impl.DoubleExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleExpressionImpl extends ExpressionImpl implements DoubleExpression
{
    ...
    {
        return ExpressionsPackage.Literals.DOUBLE_EXPRESSION;
    }
    ...
    public void setValue(String newValue)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.DOUBLE_EXPRESSION__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case ExpressionsPackage.DOUBLE_EXPRESSION__VALUE:
                return getValue();
        }
