 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.escet.tooldef.metamodel.tooldef.expressions.impl.SetExpressionImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetExpressionImpl extends ExpressionImpl implements SetExpression
{
    ...
    {
        return ExpressionsPackage.Literals.SET_EXPRESSION;
    }
    ...
    public EList<Expression> getElements()
    {
        if (elements == null)
        {
            elements = new EObjectContainmentEList<Expression>(Expression.class, this, ExpressionsPackage.SET_EXPRESSION__ELEMENTS);
        }
        return elements;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case ExpressionsPackage.SET_EXPRESSION__ELEMENTS:
