 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.escet.tooldef.metamodel.tooldef.types.impl.ListTypeImpl#getElemType <em>Elem Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListTypeImpl extends ToolDefTypeImpl implements ListType
{
    /**
    ...
    public NotificationChain basicSetElemType(ToolDefType newElemType, NotificationChain msgs)
    {
        ...
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.LIST_TYPE__ELEM_TYPE, oldElemType, newElemType);
    ...
    public void setElemType(ToolDefType newElemType)
    {
        if (newElemType != elemType)
        {
            ...
            if (elemType != null)
                msgs = ((InternalEObject)elemType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.LIST_TYPE__ELEM_TYPE, null, msgs);
            if (newElemType != null)
                msgs = ((InternalEObject)newElemType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.LIST_TYPE__ELEM_TYPE, null, msgs);
            msgs = basicSetElemType(newElemType, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.LIST_TYPE__ELEM_TYPE, newElemType, newElemType));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case TypesPackage.LIST_TYPE__ELEM_TYPE:
