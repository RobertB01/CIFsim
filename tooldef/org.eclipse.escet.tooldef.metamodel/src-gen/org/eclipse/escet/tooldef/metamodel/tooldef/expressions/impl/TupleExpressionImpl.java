 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.escet.tooldef.metamodel.tooldef.expressions.impl.TupleExpressionImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleExpressionImpl extends ExpressionImpl implements TupleExpression
{
    ...
    {
        return ExpressionsPackage.Literals.TUPLE_EXPRESSION;
    }
    ...
    public EList<Expression> getElements()
    {
        if (elements == null)
        {
            elements = new EObjectContainmentEList<Expression>(Expression.class, this, ExpressionsPackage.TUPLE_EXPRESSION__ELEMENTS);
        }
        return elements;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case ExpressionsPackage.TUPLE_EXPRESSION__ELEMENTS:
