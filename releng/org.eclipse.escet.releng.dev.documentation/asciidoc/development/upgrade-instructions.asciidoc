...
** Make a dummy change and apply it by clicking _Apply and Close_.
** Click _Yes_ when asked to _Rebuild the project now to apply the changes of the Error/Warning settings?_.
