...
Modify the last line (usually `-Xmx16g`).
Replace it by the following to change the maximum available memory from 16 link:https://en.wikipedia.org/wiki/Gibibyte[GiB] to 32 GiB:
