...
For performance reasons, it can be better to generate and compile code at
...
`org.eclipse.escet.common.app.framework.javacompiler` package. It supports
...
The compiler framework requires the use of a Java Development Kit (JDK). A
