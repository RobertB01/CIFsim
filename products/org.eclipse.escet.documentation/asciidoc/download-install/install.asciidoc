...
link:https://www.oracle.com/java/technologies/javase/javase-jdk8-downloads.html[Java SE Development Kit 8 Downloads]
...
+
In the Finder, right click the Eclipse app icon and execute _Show Package
Contents_. In the folder `Contents`, edit the file `Info.plist`. You can do this by right
