...
The Eclipse ESCET rail diagram generator makes it easy to generate pretty and
simple to understand syntax specifications. The following topics explain
the rail diagram generator in more detail:
...
We are very fond of the link:https://www.ctan.org/pkg/rail[CTAN rail package]. It is written in TeX, and
