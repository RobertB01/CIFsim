...
During the use of the Eclipse ESCET toolkit, you may encounter performance
...
In particular, the <<performance-tweak-perf-settings>> section
provides information on how to give Eclipse ESCET tools more memory. This solves the most
common performance problems and out-of-memory errors.
