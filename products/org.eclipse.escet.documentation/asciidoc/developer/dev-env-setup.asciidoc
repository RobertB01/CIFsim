...
* Download the Oomph setup (`org.eclipse.escet.setup`) from the root of the
Git repository, and save it to your computer.
...
*** Use the btn:[Browse File System...] button to select the
`org.eclipse.escet.setup` file that you previously downloaded.
*** Eclipse will turn the path into a 'file' URI.
*** Click btn:[OK].
** Select 'Supervisory Control Toolkit' in the big list. It is under 'Eclipse
Projects' / '<User>'.
** At the bottom, select the 'eclipse-move' stream.
** Click btn:[Next].
