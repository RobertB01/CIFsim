...
** Select _2020-06_ for _Product Version_.
** Select a Java 8 JDK for _Java 1.8+ VM_.
...
** For _JRE 1.8 location_ make sure to select the same Java 8 JDK that you
selected in the first wizard window.
