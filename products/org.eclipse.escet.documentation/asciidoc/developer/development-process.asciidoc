...
`develop` branch, but always use a merge request from a feature branch.
...
https://gitlab.eclipse.org/eclipse/escet/escet/-/branches[Branches page].
...
** Start the merge request title with the related issue number(s), to allow
easier tracking of merge requests back to issues.
